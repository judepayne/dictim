...
(def ex-flat
 ...
 {:type :shape,
  ...
  :parent :block}
 {:type :conn, :key [:a "--" :b "->" :c], :parent :block}
 {:type :ctr,
  :key :class,
 ...
 {:type :ctr,
  ...
  :parent "convs"}
 {:type :cmt, :key "#This is a comment", :parent "conv1"}
 {:type :list, :key ("bob" "alice"), :parent "conv1"}
 {:type :shape, :key "bob", :parent ("bob" "alice")}
 {:type :shape, :key "alice", :parent ("bob" "alice")}
 {:type :shape,
  :key "alice",
  :meta
  {:label "Alice",
 ...
 {:type :shape,
  ...
  :parent "conv1"}
 {:type :ctr, :key "awkward small talk", :parent "conv1"}
 {:type :conn,
  :key ["alice" "->" "bob"],
  :meta {:label "um, hi"},
 ...
 {:type :ctr,
  ...
  {:label "Office conversation 2",
   :attrs {"shape" "sequence_diagram"}},
  :parent "convs"}
 {:type :list, :key ("simon" "trev"), :parent "conv2"}
 {:type :shape, :key "simon", :parent ("simon" "trev")}
 {:type :shape, :key "trev", :parent ("simon" "trev")}
 {:type :shape,
  :key "simon",
 ...
 {:type :shape,
  ...
  :meta {:label "Trevor"},
  :parent "conv2"}
 {:type :ctr, :key "failed conversation", :parent "conv2"}
 {:type :conn,
  :key ["simon" "->" "trev"],
 ...
 {:type :conn,
  ...
  :parent "failed conversation"}
 {:type :ctr, :key "Carry on anyway", :parent "failed conversation"}
 {:type :conn,
  :key ["simon" "->" "trev"],
