...
[![Appveyor](https://ci.appveyor.com/api/projects/status/lsq4ewo3qcsw6wk5?svg=true)](https://ci.appveyor.com/project/judepayne/dictim)
...
```clojure
io.github.judepayne/dictim {:git/tag "0.8.2" :git/sha "16c0d2e"}
```
